...
const resources = {
  en: {
    translation: {
      ...
      // Item descriptions
      item_automatic_switch: "Automatic Switch",
      item_socket: "Socket",
      item_socket_with_earthing: "Socket with Earthing",
      item_switch_1_place: "Switch 1 Place",
  ...
  es: {
    translation: {
      ...
      // Item descriptions
      item_automatic_switch: "Interruptor automático",
      item_socket: "Enchufe",
      item_socket_with_earthing: "Enchufe con conexión a tierra",
      item_switch_1_place: "Interruptor de 1 lugar",
  ...
  hy: {
    translation: {
      ...
      // Item descriptions
      item_automatic_switch: "Ավտոմատ անջատիչ",
      item_socket: "Վարդակ",
      item_socket_with_earthing: "Վարդակ հողանցումով",
      item_switch_1_place: "Անջատիչ 1 տեղ",
      item_switch_2_places: "Անջատիչ 2 տեղ",
